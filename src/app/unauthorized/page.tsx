    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
        <div className="max-w-xl w-full text-center">
          ...
          <h1 className="mt-6 block font-extrabold tracking-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl dark:text-white drop-shadow-sm dark:drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]">403</h1>
          
          <h2 className="mt-4 md:mt-6 text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Accès refusé</h2>
